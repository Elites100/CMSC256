...
public class MyArrayList<T> implements List<T> {
    ...
    public void add(int newPosition, T newEntry) throws IndexOutOfBoundsException {
        //throw exception if new position is larger than size and have negative number
        ...
        //for (int i = newPosition; i < size; i++){array[i+1] = get(i);}
